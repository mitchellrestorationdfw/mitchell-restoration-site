...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="site-footer"><div className="footer-brand"><a className="brand" href="#top"><img src="/logo.png" alt="Mitchell Carpet Cleaning & Restoration" /></a><p>Dallas-Fort Worth, Texas</p></div><div className="footer-links"><a href="#services">Services</a><a href="#builders">Builder Services</a><a href="#about">About</a><a href="#service-area">Service Area</a><a href="#contact">Contact</a></div><div className="footer-contact"><a href="tel:9728240752">972-824-0752</a><a href="mailto:mitchellrestorationdfw@gmail.com">mitchellrestorationdfw@gmail.com</a></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Mitchell Carpet Cleaning & Restoration</span><strong>CLEAN <i>•</i> RESTORE <i>•</i> PROTECT</strong></div></footer>
    </main>
  )
}
